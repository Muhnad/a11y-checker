...
code: ${b[c].outerHTML}`);b[c].hasAttribute("placeholder")&&console.warn(`the placeholder is not guaranteed to be read by assisitive technowarnies, should include aria-label OR label for element.
