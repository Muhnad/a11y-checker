...
code: ${c[d].outerHTML}`)}})(),(()=>{const c=b("*");for(let d=0;d<c.length;d++)(c[d].hasAttribute("onclick")||c[d].hasAttribute("onClick"))&&(c[d].hasAttribute("tabindex")||a(`Please add tabindex to element id: ${c[d].id} & class: ${c[d].className}`))})()};window.addEventListener("load",a);